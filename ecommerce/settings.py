...
SECRET_KEY = 'django-insecure-cx0$0nn#l4k-wyfu+g3!u!o9_r$ja7b19)(4cbhn-))l#+btkg'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'loja.global_functions.carrinho'
            ],
        },
    },
]
...
STATIC_URL = 'static/' #caminho estático. serve pro {% static %} resolver caminhos dps
